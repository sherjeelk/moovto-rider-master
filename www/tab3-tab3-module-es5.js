...
var Tab3Page = /** @class */ (function () {
    function Tab3Page(http, storage, toast) {
        this.http = http;
    ...
    Tab3Page.prototype.presentToast = function (msg) {
    ...
    Tab3Page.prototype.getOrders = function () {
        var _this = this;
        console.log('GET ORDERS', { headers: { Authorization: "Bearer " + _AppConstants__WEBPACK_IMPORTED_MODULE_3__["AppConstants"].token } });
        this.http.get(_AppConstants__WEBPACK_IMPORTED_MODULE_3__["AppConstants"].API.ORDERS + '?rider=' + _AppConstants__WEBPACK_IMPORTED_MODULE_3__["AppConstants"].user.id, { headers: { Authorization: "Bearer " + _AppConstants__WEBPACK_IMPORTED_MODULE_3__["AppConstants"].token } }).subscribe(function (res) {
            _this.orders = JSON.parse(JSON.stringify(res));
            console.log('Order placed', _this.orders);
        }, function (error) {
            console.error(error);
        });
    };
    Tab3Page.prototype.itemsToName = function (items) {
        var name = '';
    ...
    Tab3Page.prototype.copyToClipBoard = function (val) {
