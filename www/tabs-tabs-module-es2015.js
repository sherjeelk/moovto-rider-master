...
let TabsPage = class TabsPage {
    constructor(http, socket, storage) {
        this.http = http;
        this.socket = socket;
        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    {
                        path: '',
                        loadChildren: () => Promise.all(/*! import() | tab2-tab2-module */[__webpack_require__.e("default~delivery-successful-delivery-successful-module~login-login-module~tab1-tab1-module~tab2-tab2~d6831f89"), __webpack_require__.e("tab2-tab2-module")]).then(__webpack_require__.bind(null, /*! ../tab2/tab2.module */ "./src/app/tab2/tab2.module.ts")).then(m => m.Tab2PageModule)
                    }
                ]
            },
            {
                ...
                children: [
                    {
                        path: '',
                        loadChildren: () => Promise.all(/*! import() | tab3-tab3-module */[__webpack_require__.e("default~delivery-successful-delivery-successful-module~login-login-module~tab1-tab1-module~tab2-tab2~d6831f89"), __webpack_require__.e("tab3-tab3-module")]).then(__webpack_require__.bind(null, /*! ../tab3/tab3.module */ "./src/app/tab3/tab3.module.ts")).then(m => m.Tab3PageModule)
                    }
                ]
            },
            {
