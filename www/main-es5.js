...
var map = {
	"./delivery-successful/delivery-successful.module": [
		"./src/app/delivery-successful/delivery-successful.module.ts",
		"default~delivery-successful-delivery-successful-module~login-login-module~tab1-tab1-module~tab2-tab2~d6831f89",
		"delivery-successful-delivery-successful-module"
	],
	"./login/login.module": [
...
var AppConstants = /** @class */ (function () {
    ...
    AppConstants.GET_MAPS_URL = function (latLng) {
        return AppConstants_1.API.GET_ADDRESS + latLng + '&key=' + AppConstants_1.API_KEY_MAP;
    };
    var AppConstants_1;
    AppConstants.BASE_URL = 'https://api.easyshifters.com';
    AppConstants.APP_API_URL = 'https://www.easyshifters.com/api';
    AppConstants.ONGOING = false;
    AppConstants.ADDED = false;
    AppConstants.ORDER = {
        items: []
    };
    AppConstants.API = {
        LOGIN: AppConstants_1.BASE_URL + '/auth/local',
        CATEGORIES: AppConstants_1.BASE_URL + '/categories?enable=true',
        REGISTER: AppConstants_1.BASE_URL + '/auth/local/register',
        VEHICLES: AppConstants_1.BASE_URL + '/vehicles',
        CHARGES: AppConstants_1.BASE_URL + '/charges',
        USER: AppConstants_1.BASE_URL + '/users',
        ORDERS: AppConstants_1.BASE_URL + '/orders',
        EXTRA_CHARGES: AppConstants_1.BASE_URL + '/extracharges',
    ...
    AppConstants.GOOGLE_ID = '231615036695-gklc894u9a3k5ei32e01svbrld7f9nn4.apps.googleusercontent.com';
    AppConstants = AppConstants_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
module.exports = ".full-width {\n  width: 100%;\n}\n\n.blue-button {\n  background: #2196F3;\n  color: whitesmoke;\n  padding: 1%;\n}\n\n.grey-button {\n  background: #009688;\n  color: whitesmoke;\n  padding: 1%;\n}\n\n.link-text {\n  color: dodgerblue;\n}\n\n.text-light-grey {\n  color: #767676;\n}\n\n.text-dark-grey {\n  color: #212121;\n}\n\n.m-n-t-1 {\n  margin-top: -1px;\n}\n\n.m-n-t-2 {\n  margin-top: -2px;\n}\n\n.m-n-t-3 {\n  margin-top: -3px;\n}\n\n.m-n-t-4 {\n  margin-top: -4px;\n}\n\n.m-n-t-5 {\n  margin-top: -5px;\n}\n\n.m-n-t-6 {\n  margin-top: -6px;\n}\n\n.avatar {\n  vertical-align: middle;\n  width: 50px;\n  height: 50px;\n  border-radius: 50%;\n}\n\n.color-light {\n  color: #fafafa;\n}\n\n.header p {\n  margin-bottom: 0 !important;\n}\n\n.side-nav {\n  font-family: \"Karla\", sans-serif !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.initializeApp = function () {
        ...
        this.storage.get('login').then(function (value) {
            _AppConstants__WEBPACK_IMPORTED_MODULE_6__["AppConstants"].IS_LOGGED_IN = value;
        ...
        this.storage.get('token').then(function (value) {
            _AppConstants__WEBPACK_IMPORTED_MODULE_6__["AppConstants"].token = value;
        });
    };
    ...
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"],
            ...
            _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_4__["StatusBar"], _ionic_storage__WEBPACK_IMPORTED_MODULE_5__["Storage"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["Router"]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var ngx_socket_io__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ngx-socket-io */ "./node_modules/ngx-socket-io/fesm5/ngx-socket-io.js");
...
/* harmony import */ var _AppConstants__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./AppConstants */ "./src/app/AppConstants.ts");
...
var config = { url: 'https://www.easyshifters.com', options: {} };
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(),
                _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"], _ionic_storage__WEBPACK_IMPORTED_MODULE_12__["IonicStorageModule"].forRoot(),
                ...
                _agm_core__WEBPACK_IMPORTED_MODULE_16__["AgmCoreModule"].forRoot({
                    apiKey: _AppConstants__WEBPACK_IMPORTED_MODULE_15__["AppConstants"].API_KEY_MAP
                }),
                ng_lottie__WEBPACK_IMPORTED_MODULE_7__["LottieAnimationViewModule"].forRoot(),
                _angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HttpClientModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_10__["BrowserAnimationsModule"]],
            providers: [
                _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"],
                _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_5__["SplashScreen"],
                _socket_service__WEBPACK_IMPORTED_MODULE_14__["SocketService"],
...
var SocketService = /** @class */ (function () {
    ...
    SocketService.prototype.getDelivery = function () {
        var _this = this;
        this.socket.on('delivery', function (value) {
            if (value.rider === _AppConstants__WEBPACK_IMPORTED_MODULE_3__["AppConstants"].user.rider.id) {
                console.log('Its for me', value);
                if (!_AppConstants__WEBPACK_IMPORTED_MODULE_3__["AppConstants"].ONGOING) {
                    _this.getOrderDetails(value.order);
                }
                else {
                ...
                console.log('Someone else', value.rider, _AppConstants__WEBPACK_IMPORTED_MODULE_3__["AppConstants"].user.rider.id);
            }
        });
    };
    SocketService.prototype.getOrderDetails = function (id) {
        var _this = this;
        this.http.get(_AppConstants__WEBPACK_IMPORTED_MODULE_3__["AppConstants"].API.ORDERS + '/' + id).subscribe(function (data) {
    ...
    SocketService.prototype.getMapImage = function () {
        this.delivery.map = "https://maps.googleapis.com/maps/api/staticmap?center=" + this.delivery.pickup_lat + "," + this.delivery.pickup_lng + "&zoom=13&size=600x300\n    &maptype=roadmap&markers=color:blue%7Clabel:P%7C" + this.delivery.pickup_lat + "," + this.delivery.pickup_lng + "&markers=color:blue%7Clabel:D%7C" + this.delivery.drop_lat + ",\n            " + this.delivery.drop_lng + "&key=" + _AppConstants__WEBPACK_IMPORTED_MODULE_3__["AppConstants"].API_KEY_MAP;
    };
    SocketService.prototype.sendAdminMessage = function (data) {
    ...
    SocketService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [ngx_socket_io__WEBPACK_IMPORTED_MODULE_2__["Socket"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"]])
    ], SocketService);
...
module.exports = __webpack_require__(/*! D:\siddharth\research\web-projects\ionic\snatch-rider\src\main.ts */"./src/main.ts");
